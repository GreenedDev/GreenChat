package net.multylands.greenchat;

import net.kyori.adventure.platform.bukkit.BukkitAudiences;
import net.kyori.adventure.text.minimessage.MiniMessage;
import net.multylands.greenchat.commands.ChatCommand;
import net.multylands.greenchat.commands.subcommands.ClearChatCommand;
import net.multylands.greenchat.commands.subcommands.ToggleAlertsCommand;
import net.multylands.greenchat.commands.subcommands.ReloadCommand;
import net.multylands.greenchat.commands.subcommands.ToggleChatCommand;
import net.multylands.greenchat.listeners.checks.*;
import net.multylands.greenchat.listeners.mentions.Mentions;
...
public class GreenChat extends JavaPlugin implements Listener {
